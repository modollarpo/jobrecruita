    ...
    <section class="section benefits bgcolor--gray-10 mt-5 pt-5">
        <div class="container">
            <div class="row mt-5 pt-5">
                <h4 class="text-info">
                    {{ __('total_amount_to_pay') }}: {{ currencyPosition($plan->price, true) }}
                </h4>
            </div>
            <div class="row py-5">
                <h5>{{ __('Available Payment Methods') }}</h5>
                @if (
                    config('paypal.active') ||
                    ...
                    @if (config('paypal.active') && ((config('paypal.mode') == 'sandbox' && config('paypal.sandbox.client_id') && config('paypal.sandbox.client_secret')) || (config('paypal.mode') != 'sandbox' && config('paypal.live.client_id') && config('paypal.live.client_secret'))))
                        ...
                        <div class="col-4 my-2">
                            <div class="card jobcardStyle1">
                                <div class="card-body">
                                    <div class="rt-single-icon-box">
                                        <div class="iconbox-content">
                                            <div class="body-font-1 rt-mb-12">{{ __('flutterwave') }}</div>
                                        </div>
                                    </div>
                                    <div class="post-info d-flex">
                                        <div class="flex-grow-1">
                        ...
                        <div class="col-4 my-2">
                            <div class="card jobcardStyle1">
                                <div class="card-body">
                                    <div class="rt-single-icon-box">
                                        <div class="iconbox-content">
                                            <div class="body-font-1 rt-mb-12">{{ __('mollie') }}</div>
                                        </div>
                                    </div>
                                    <div class="post-info d-flex">
                                        <div class="flex-grow-1">
                    ...
                    @if (config('zakirsoft.im_active') && config('zakirsoft.im_key') && config('zakirsoft.im_secret') && config('zakirsoft.im_url'))
                        <div class="col-4 my-2">
                            <div class="card jobcardStyle1">
                                <div class="card-body">
                                    <div class="rt-single-icon-box">
                                        <div class="iconbox-content">
                                            <div class="body-font-1 rt-mb-12">{{ __('instamojo') }}</div>
                                        </div>
                                    </div>
                                    <div class="post-info d-flex">
                                        <div class="flex-grow-1">
                        ...
                        <div class="col-4 my-2">
                            <div class="card jobcardStyle1">
                                <div class="card-body">
                                    <div class="rt-single-icon-box">
                                        <div class="iconbox-content">
                                            <div class="body-font-1 rt-mb-12">{{ __('midtrans') }}</div>
                                        </div>
                                    </div>
                                    <div class="post-info d-flex">
                                        <div class="flex-grow-1">
                    ...
                    @if (config('zakirsoft.ssl_active') && config('zakirsoft.ssl_id') && config('zakirsoft.ssl_pass') && config('zakirsoft.ssl_mode'))
                        <div class="col-4 my-2">
                            <div class="card jobcardStyle1">
                                <div class="card-body">
                                    <div class="rt-single-icon-box">
                                        <div class="iconbox-content">
                                            <div class="body-font-1 rt-mb-12">{{ __('sslcommerz') }}</div>
                                        </div>
                                    </div>
                                    <div class="post-info d-flex">
                                        <div class="flex-grow-1">
                ...
                @else
                    <div class="text-center">
                        ...
                        <h5 class="mt-4">{{ __('No payment methods are currently available. Please contact support for assistance.') }}</h5>
                    </div>
                @endif
            </div>
            @if ($manual_payments && count($manual_payments))
                <div class="row mb-5">
                    <h5>{{ __('Manual Payment Gateways') }}</h5>
        ...
        <form action="{{ route('paypal.post') }}" method="POST" class="d-none" id="paypal-form">@csrf</form>
        <form action="{{ route('stripe.post') }}" method="POST" class="d-none">@csrf
        ...
        <form action="{{ route('razorpay.post') }}" method="POST" class="d-none">@csrf
        ...
        <form action="{{ route('paystack.post') }}" method="POST" class="d-none" id="paystack-form">@csrf</form>
        @if (config('zakirsoft.flw_public_key') && config('zakirsoft.flw_secret') && config('zakirsoft.flw_secret_hash') && config('zakirsoft.flw_active'))
            <form method="POST" action="https://checkout.flutterwave.com/v3/hosted/pay" id="flutter-form">
                <input type="hidden" name="public_key" value="{{ config('zakirsoft.flw_public_key') }}" />
        ...
        @endif
        <form action="{{ route('mollie.payment') }}" method="POST" class="d-none" id="mollie-form">@csrf</form>
        <form action="{{ route('instamojo.pay') }}" method="POST" class="d-none" id="instamojo-form">@csrf</form>
