                ...
                <div class="col-lg-9 col-md-8">
                    <div class="mx-646">
                        ...
                        <p class="body-font-2 text-gray-500 rt-mb-0">
                            Jobrecruita is where skilled professionals meet forward-thinking employers. We simplify job search and hiring with smart technology, making the process fast, transparent, and effective for everyone.<br><br>
                            Whether you’re seeking your next role or your next great hire, Jobrecruita gives you the tools and support to succeed. Join us and experience recruitment made easy.
                        </p>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center text-h4 ft-wt-5">
                        <label for="">Why choose</label>
                        <span class="text-primary-500 has-title-shape">{{ str_replace('Jobpilot', 'Jobrecruita', config('app.name')) }}
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 rt-mb-24 position-relative">
                        <div class="rt-single-icon-box working-progress icon-center">
                            ...
                            <div class="iconbox-content">
                                <div class="body-font-2 rt-mb-12">Fast & Simple</div>
                                <div class="body-font-4 text-gray-400">
                                    Post jobs or find opportunities in minutes. Our platform is built for speed and ease.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 rt-mb-24 position-relative">
                        <div class="rt-single-icon-box working-progress icon-center">
                            ...
                            <div class="iconbox-content">
                                <div class="body-font-2 rt-mb-12">Quality Matches</div>
                                <div class="body-font-4 text-gray-400">
                                    Smart matching connects the right candidates with the right employers.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 rt-mb-24 position-relative">
                        <div class="rt-single-icon-box working-progress icon-center">
                            ...
                            <div class="iconbox-content">
                                <div class="body-font-2 rt-mb-12">Transparent & Supportive</div>
                                <div class="body-font-4 text-gray-400">
                                    Clear processes and real support for both employers and job seekers.
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-6">
                        ...
                        <h3 class="lg:tw-mb-8 tw-mb-4">Empowering Better Careers and Hiring</h3>
                        <p class="body-font-2 text-gray-500 lg:tw-mb-0 tw-mb-4">
                            Our mission is to make job searching and hiring simple, transparent, and rewarding for everyone. We connect great talent with great companies, using technology to remove barriers and help people and businesses grow. At Jobrecruita, we believe in opportunity for all.
                        </p>
                    </div>
                    <div class="col-md-6">
                        <div>
    ...
    @section('script')
        ...
        <script>
            ...
            $(".testimonail_active").slick((_$$slick = {
                ...
                }, _defineProperty(_$$slick, "prevArrow", '<button type="button" class="slide-arrow prev-arrow"></button>'),
                _defineProperty(_$$slick, "nextArrow", '<button type="button" class="slide-arrow next-arrow"></button>'),
