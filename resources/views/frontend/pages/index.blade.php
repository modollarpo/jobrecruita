                        ...
                        <div class="banner-content5">
                            <div class="mx-727" data-aos="fadeindown" data-aos-duration="1000">
                                <h1 class="text-gray-900 rt-mb-24">
                                    Find Your Next Opportunity, Fast and Easy
                                </h1>
                                <div class="f-size-18 text-gray-600 rt-mb-30">
                                    Discover jobs that fit your skills and ambitions. Start your journey with Jobrecruita and connect with top employers today.
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 rt-mb-24">
                    <div class="rt-single-icon-box working-progress icon-center">
                        ...
                        <div class="iconbox-content">
                            <div class="body-font-2 rt-mb-12">Smart Connections</div>
                            <div class="body-font-4 text-gray-400">
                                We match the right talent with the right opportunities, making hiring and job searching faster and more effective.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 rt-mb-24">
                    <div class="rt-single-icon-box working-progress icon-center">
                        ...
                        <div class="iconbox-content">
                            <div class="body-font-2 rt-mb-12">Effortless Experience</div>
                            <div class="body-font-4 text-gray-400">
                                Our platform is easy to use for both employers and job seekers—post, search, and apply in just a few clicks.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6 rt-mb-24">
                    <div class="rt-single-icon-box working-progress icon-center">
                        ...
                        <div class="iconbox-content">
                            <div class="body-font-2 rt-mb-12">Quality Results</div>
                            <div class="body-font-4 text-gray-400">
                                Access a large pool of verified candidates and top companies, ensuring the best fit for every role.
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 rt-mb-24 position-relative">
                    <div class="has-arrow first">
                        <img src="{{ asset('frontend') }}/assets/images/all-img/arrow-1.png" alt="" draggable="false">
                    </div>
                    <div class="rt-single-icon-box working-progress icon-center">
                        <div class="icon-thumb rt-mb-24">
                            <div class="icon-72">
                        ...
                        <div class="iconbox-content">
                            <div class="body-font-2 rt-mb-12">Find Jobs</div>
                            <div class="body-font-4 text-gray-400">
                                Search thousands of jobs tailored to your skills and interests.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 rt-mb-24 col-sm-6 position-relative">
                    <div class="has-arrow middle">
                        <img src="{{ asset('frontend') }}/assets/images/all-img/arrow-2.png" alt="" draggable="false">
                    </div>
                    <div class="rt-single-icon-box working-progress icon-center">
                        <div class="icon-thumb rt-mb-24">
                            <div class="icon-72">
                        ...
                        <div class="iconbox-content">
                            <div class="body-font-2 rt-mb-12">Create Profile</div>
                            <div class="body-font-4 text-gray-400">
                                Build a standout profile to showcase your experience and strengths.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 rt-mb-24 col-sm-6 position-relative">
                    ...
                    <div class="rt-single-icon-box working-progress icon-center">
                        ...
                        <div class="iconbox-content">
                            <div class="body-font-2 rt-mb-12">Apply Easily</div>
                            <div class="body-font-4 text-gray-400">
                                Apply to jobs in just a few clicks—no complicated steps.
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 rt-mb-24 col-sm-6">
                    <div class="rt-single-icon-box working-progress icon-center">
                        ...
                        <div class="iconbox-content">
                            <div class="body-font-2 rt-mb-12">Track Progress</div>
                            <div class="body-font-4 text-gray-400">
                                Monitor your applications and stay updated every step of the way.
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="tw-p-6 !tw-pb-[72px]">
                                        <div class="rt-single-icon-box tw-gap-3">
                                            <div class="tw-w-14 tw-h-14">
                                                <img class="tw-w-full tw-h-full tw-object-cover" src="{{ $company->logo_url }}" alt="" draggable="false"
                                                    class="object-fit-contain">
                                            </div>
                                            <div class="iconbox-content">
                                                <div class="">
                                                    <span class="tw-text-[#191F33] tw-text-lg tw-font-medium  tw-inline-block">{{ $company->user->name }}</span>
                                                </div>
                                        ...
                                        <div class="post-info">
                                            <div class="tw-flex tw-flex-wrap tw-gap-3">
                                                <span class="tw-px-3 tw-py-1 tw-inline-block tw-text-sm tw-font-medium tw-text-[#474C54] tw-rounded-[52px] ll-gray-border">
                                                    {{ $company?->industry?->name ?? '' }}
                                                </span>
                                                <span class="tw-px-3 tw-py-1 tw-inline-block tw-text-sm tw-font-medium tw-text-[#474C54] tw-rounded-[52px] ll-gray-border">{{$company->jobs_count}} {{ __('open_position') }}</span>
                                            </div>
                                            <div class="tw-absolute tw-bottom-6 tw-left-6 tw-text-base tw-font-semibold tw-capitalize tw-inline-flex tw-items-center tw-gap-1">
